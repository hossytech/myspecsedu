...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
      ...
      formData.append("access_key", "7002f773-935c-4eac-b013-3e8017468b36");
    ...
    return (
        <div className="contact">
            <div className="contact-col">
                ...
                <ul>
                    <li><img src={mail_icon} alt="" />myspecsedu@gmail.com</li>
                    <li><img src={phone_icon} alt="" />(234) 7022-2211-11</li>
                    <li><img src={location_icon} alt="" />222 Oniru, VI <br />
                        Lagos, Nigeria 
                    </li>
                </ul>
            </div>
